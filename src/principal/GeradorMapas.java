	...
	public static void gerarMapa() {
        ...
        for (int i = 0; i < numLinhas; i++) {
            for (int j = 0; j< numColunas; j++) {
                if (i == 0 || i == numLinhas - 1 || j == 0 || j == numColunas - 1) { //condição para gerar os bolcos da borda do mapa
                    mapa[i][j] = 1;
                } else if ((i % 2 == 0) && (j % 2 == 0)) { //condição para posicionar os blocos fixo no mapa
                    mapa[i][j] = 1;
                } else {
